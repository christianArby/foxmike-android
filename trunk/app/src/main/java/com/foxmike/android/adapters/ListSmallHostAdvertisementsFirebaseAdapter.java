...
import com.foxmike.android.utils.SmallHostAdvertisementViewHolder;
...
public class ListSmallHostAdvertisementsFirebaseAdapter extends FirebaseRecyclerAdapter<Advertisement, SmallHostAdvertisementViewHolder> {
     ...
     */
    public ListSmallHostAdvertisementsFirebaseAdapter(FirebaseRecyclerOptions<Advertisement> options, Context context, AlertOccasionCancelledListener alertOccasionCancelledListener, HashMap<String,String> sessionTypeDictionary, OnSessionClickedListener onSessionClickedListener) {
        super(options);
    ...
    @NonNull
    @Override
    public SmallHostAdvertisementViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.advertisement_host_small_single_layout, parent, false);
        return new SmallHostAdvertisementViewHolder(view);
    }

    @Override
    protected void onBindViewHolder(@NonNull SmallHostAdvertisementViewHolder holder, int position, @NonNull Advertisement model) {
        ...
        holder.setText4(context.getResources().getString(R.string.number_of_participants) + " " + countParticipants +"/" + maxParticipants);
